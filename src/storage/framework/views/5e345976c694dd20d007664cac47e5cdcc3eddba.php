...
<head>
    ...
    <script src="<?php echo e(asset('/js/jquery-3.7.0.min.js'), false); ?>"></script>
    <script src="<?php echo e(asset('js/toastr.min.js'), false); ?>" defer></script>
    ...
    <link href="<?php echo e(asset('css/toastr.css'), false); ?>" rel="stylesheet">
...
<?php /**PATH E:\RCHH_Works\Crowdworks\Laravel\Laravel-admin\jpf_pm\src\resources\views/layouts/app.blade.php ENDPATH**/ ?>